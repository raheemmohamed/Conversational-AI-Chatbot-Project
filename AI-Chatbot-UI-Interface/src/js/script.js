...
const notificationAlert = new Audio(
  "https://cdn.jsdelivr.net/gh/raheemmohamed/AI-Chatbot/dist/v1/sounds/message-notification.mp3"
);
...
window.chatbot.brandImage =
  "https://cdn.jsdelivr.net/gh/raheemmohamed/AI-Chatbot/dist/v1/images/chatbot.png";
...
async function generateAnswares(userQuestion) {
  try {
    let chatAPIUrl = `http://localhost:3000/api/v1/organization/generateCompletion?key=${chatbot.apiKey}`;
